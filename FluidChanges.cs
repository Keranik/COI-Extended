...
namespace FluidChanges
{
    public class FluidChangePH
    {
        ...
        public void StartUp(ProtoRegistrator registrator)
        {
            ...
            if (addT5StorageTier) { AddTier5Storages(); AddResearchData(); }
        ...
        private void AddResearchData()
        {
            ...
            {           
                ...
                .Start("Mega Storage", COIExtended.COIExtended.Research.UnlockExpandedStorages)
                .Description("Even more options for storage with more IO support.")
                .AddLayoutEntityToUnlock(COIExtended.COIExtended.Research.StorageFluidT5, false)
                .AddLayoutEntityToUnlock(COIExtended.COIExtended.Research.StorageUnitT5, false)
                .AddLayoutEntityToUnlock(COIExtended.COIExtended.Research.StorageLooseT5, false)
                .SetCosts(new ResearchCostsTpl(69))
                .BuildAndAdd();
                nodeProto.GridPosition = new Vector2i(130, 18);
                nodeProto.AddParent(registrator.PrototypesDb.GetOrThrow<ResearchNodeProto>(Ids.Research.ConsumerElectronics));
            }
            catch { }
        }
        private void AddTier5Storages()
        {
            registrator.StorageProtoBuilder
                .Start("Fluid Storage V", COIExtended.COIExtended.Research.StorageFluidT5)
                .Description("Fluid storage with more capacity and more IO")
                .SetCost(Costs.Buildings.VehiclesDepot3)
            ...
            registrator.StorageProtoBuilder
                    .Start("Loose Storage V", COIExtended.COIExtended.Research.StorageLooseT5)
            ...
            registrator.StorageProtoBuilder
                   .Start("Unit Storage V", COIExtended.COIExtended.Research.StorageUnitT5)
