...
internal class StackerT2 : IModData
{
    public void RegisterData(ProtoRegistrator registrator)
    {
        ...
        StaticEntityProto.ID stacker = NewIDs.Transports.StackerT2;
        Proto.Str strings = Proto.CreateStr(NewIDs.Transports.StackerT2, "Stacker II", "Dumps material from connected conveyor belts directly on the terrain.", null);
